...
test('Suwasewana Full Flow: Create Account and Book Appointment', async ({ page }) => {
  ...
  await page.locator('input[type="text"]').fill('Imanshiiiii');
  await page.locator('input[type="email"]').fill('padmi3456@gmail.com');
  await page.locator('input[type="password"]').fill('password1234imasn');
